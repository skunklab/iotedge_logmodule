...
import-module C:\_git\dev\piraeus_0.9.0_prerelease\src\Piraeus\Powershell\Piraeus.Module\Piraeus.Module\bin\Debug\Piraeus.Module.dll
...
$url = "http://localhost:1733"  #Replace with Host name or IP address of the Piraeus Web Gateway
